...
# Mantemos a importação do serviço de CID para evitar erros no AtendimentoMedico
...
class Usuario(AbstractUser):
    ...
    Herda de AbstractUser para ganhar campos como username, password, email, first_name, etc.
    """

    # --- 1. CAMPOS DE CONTROLE ---
    ...
    # --- 2. CAMPOS PROFISSIONAIS (Usados nas Permissões) ---
    ...
    # --- 3. CONFIGURAÇÕES DO DJANGO AUTH ---
    # Define que o login será feito pelo campo 'username' (padrão)
    # Se quisesse login por email, mudaria aqui para 'email'
    USERNAME_FIELD = 'username'

    # Campos obrigatórios ao criar superuser via terminal (além do username e password)
