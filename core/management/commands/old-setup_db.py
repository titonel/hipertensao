...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        meds_completo = [
            ...
            ('Diurético Tiazídico/Símil', 'Hidroclorotiazida', '25mg', 'Clorana'),
            ...
            # --- DIURÉTICOS DE ALÇA ---
            ('Diurético de Alça', 'Furosemida', '40mg', 'Lasix'),
            ...
            ('IECA', 'Captopril', '25mg', 'Capoten'),
            ('IECA', 'Captopril', '50mg', 'Capoten'),
            ('IECA', 'Enalapril, Maleato', '10mg', 'Renitec, Eupressin')
            ('IECA', 'Enalapril, Maleato', '20mg', 'Renitec, Eupressin'),
            ...
            ('BRA', 'Losartana Potássica', '50setup_db.pymg', 'Aradois, Cozaar'),
            ...
            ('BCC (Diidropiridínico)', 'Anlodipino, Besilato', '5mg', 'Norvasc, Pressat'),
            ('BCC (Diidropiridínico)', 'Anlodipino, Besilato', '10mg', 'Norvasc, Pressat'),
